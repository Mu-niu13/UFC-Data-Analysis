...
coefficients_table <- tidy(final_model) %>%
  mutate(
    Predictor = case_when(
...
model_fit_table <- glance(final_model) %>%
...
kable(coefficients_table, caption = "Logistic Regression Model Coefficients", format = "pipe", digits = 3) %>%
  kable_styling(full_width = FALSE)

# Print model fit statistics table
kable(model_fit_table, caption = "Model Fit Statistics", format = "pipe", digits = 3) %>%
  kable_styling(full_width = FALSE)
# Render the table
