...
kable(coefficients_table_sim, caption = "Logistic Regression Model Coefficients", format = "pipe", digits = 3) %>%
  kable_styling(full_width = FALSE)

# Print model fit statistics table
kable(model_fit_table_sim, caption = "Model Fit Statistics", format = "pipe", digits = 3) %>%
  kable_styling(full_width = FALSE)
# Render the table
